...
public static class Helpers
{
    ...
    public static async Task<string> UploadFile(IFormFile file)
    {
         ...
         */
        if (file.Length == 0 || file == null) throw new Exception("File is empty");

        /***
         * validate the size of the file
         * if exceed throw exception that that is exceeded
         */
        if (file.Length > 1024 * 5) throw new Exception("File is more than 5 mb");

        /***
         *
         */
        var uploadFolder = Path.Combine(Directory.GetCurrentDirectory(), "src/Shared/Files");
